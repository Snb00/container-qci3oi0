...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qci3oi0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qci3oi0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Snb00/container-qci3oi0.git
cd container-qci3oi0
```
...
```
docker attach container-qci3oi0
```
